        ...
        <div class="row-account row">
            <div class="avatar col-md-3">
                ...
                <div class="profile-name">
                    <h1 class="h3"><?php echo $user['username']; ?></h1>
                </div>
            </div>
            ...
            <div class="update col-md-2">
                ...
                <form action="../api/follows/store.php?id=<?php echo $user['id'] ?>" method="POST"
                      class="mb-3 d-flex align-items-center">
                    <button type="submit" class="btn btn-update">S'abonner
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
